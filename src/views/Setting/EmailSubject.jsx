                    ...
                    <Row>
                        <Col md={6}>
                            <FormGroup controlId="formControlsSelectMultiple">
                                <ControlLabel><b>Email Task Title<span className="text-danger big-font"> *</span></b></ControlLabel>
                                <input type="text" className={this.state.letterCount > 45 ? 'form-control border-color-red' : 'form-control'} name="report" placeholder="Enter task title" required="required" value={this.state.title} onChange={(e)=>this.fieldValue(e)} disabled={this.state.isDisable}/>
                            </FormGroup>
                        </Col>
